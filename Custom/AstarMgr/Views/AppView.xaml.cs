...
namespace AstarMgr.Views
{
    ...
    public partial class AppView : Window
    {
        ...
        public AppView()
        {
            ...
            //ShowNotifyIcon("AstarMgr",
            //    string.Format("AstarMgr started at {0:d} {0:T}", DateTime.Now),
        ...
        private void ShowNotifyIcon(string Title, string Text, System.Windows.Forms.ToolTipIcon ToolTipIcon, int DisplayTime)
        {
            ...
            System.IO.Stream iconStream = Application.GetResourceStream(new Uri("pack://application:,,,/AstarMgr;component/Resources/Logo.ico")).Stream;
            if (iconStream != null)
            {
