...
namespace SimulaRV
{
    public class SimulaShuttle_Ctr : TrafficController
    {
        ...
        public async Task<string> WriteVariableShuttleAsync(ESimulaShuttleCtr_Variables variable, int value)
        {
            ...
            switch (variable)
            {
                ...
                case ESimulaShuttleCtr_Variables.Debordo_Culla:
                    ...
                    command = await Global.Instance.ReadDataAsync(scbLift, areaLift, startAddress, 1);
                ...
                case ESimulaShuttleCtr_Variables.Presenza_Satellite:
                    ...
                    command = await Global.Instance.ReadDataAsync(scbShuttle, areaShuttle, startAddress, 1);
                    command = Utils.BoolToPlcString(command, 0, (value > 0), _swapBYTEForBool);
                    scb = scbShuttle;
                    area = areaShuttle;
                    break;
        ...
        public async Task<string> WriteVariableTrasloAsync(ERVTrasloCtr_Variables variable, int value)
        {
            if (_cfgCradles == null)
            {
                return "Il controller non è configurato per eseguire scrittura di variabili";
            ...
            var cradleTraslo = _cfgCradles.FirstOrDefault(c => c.MOD_PLN_Code.StartsWith("TR"));
            ...
            switch (variable)
            {
                ...
                case ERVTrasloCtr_Variables.Centro_Forche:
                    ...
                    command = await Global.Instance.ReadDataAsync(scbTraslo, areaTraslo, startAddress, 1);
                    command = Utils.BoolToPlcString(command, 0, (value > 0), _swapBYTEForBool);
                    scb = scbTraslo;
                    area = areaTraslo;
                    break;
        ...
        //protected override string SetMessageID(string message)
        //{
